...
# VERSÃO 1.3: Final, com remoção manual do PPA quebrado.
...
sudo apt-get update
ESSENTIAL_PACKAGES=( "curl" "wget" "git" "software-properties-common" "apt-transport-https" "ca-certificates" "gnupg" )
...
PACKAGES_TO_REMOVE=( "libreoffice*" "aisleriot" "gnome-mahjongg" "gnome-mines" "gnome-sudoku" "thunderbird" )
sudo apt-get purge -y "${PACKAGES_TO_REMOVE[@]}" || true
log_info "Limpando dependências órfãs..."
sudo apt-get autoremove -y || true
echo "✅ Limpeza de software concluída."

echo -e "\n🎉 O sistema está preparado e pronto para as instalações do Academix!"
exit 0
